                    ...
                    <div className="w3-row">
                        <div className="w3-col l1">
                            <div className="speaker-alphabet-listing">
                                <h4 className="speakers-inpage" id="alphaShortcuts"><a href="#af">A - F</a> &mdash; <a
                                    href="#gm">G
                            ...
                            <div className="speaker-shortcuts-region">
                                <h4 className="speakers" id="speakerShortcuts"><a href="#czerniak">Czerniak</a> - &nbsp;
                                    ...
                                    <a href="#girot">Girot</a> - <a href="#imbert">Imbert</a> - <a
                                        ...
                                        href="#latz">Latz</a> - <a href="#lee">Lee</a> - <a
                                        href="#lister">Lister</a> - <a
                                        href="#orff">Orff</a> -<br/>
                                    <a href="#randall">Randall</a> - <a href="#redman">Redman</a> - <a
                                        href="#robbins">Robbins</a> - <a href="#seavittnordenson">Seavitt
                                        Nordenson</a> - <a
                    ...
                    <div className="speaker-body" id="speakerBody">
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-name-col">
                                    <div className="sp-name">
                                        <h3 className="speakerName"><a name="czerniak"><a name="af">Julia
                                            Czerniak</a></a>
                                        </h3>
                                    </div>
                                </div>
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Professor & Associate Dean, Syracuse
                                            Architecture</p>
                                        <p>
                                            Julia Czerniak is Associate Dean and Professor of Architecture at Syracuse
                                            University where she teaches studios as well as seminars on landscape theory
                                            and
                                            criticism. Czerniak is educated both as an architect (Princeton University,
                                            M.
                                            Arch 1992) and landscape architect (Pennsylvania State University, BA 1984)
                                            and
                                            her research and practice draws on the intersection of these disciplines.
                                            Although the techniques, scales and products of her research vary,
                                            Czerniak’s
                                            work focuses on the physical and cultural potentials of urban landscapes.
                                            Recent
                                            design research advances landscape as a protagonist in the remaking of
                                            Rust-Belt
                                            cities, from a series of public space interventions along a derelict creek
                                            to
                                            ecologically and spatially rich streetscapes for a newly planned campus of
                                            Syracuse University. Czerniak’s work as a designer is complemented by her
                                            work
                                            as educator and writer, which in all cases advances design as a way to
                                            enable
                        ...
                        <div className="individual-speaker name-column berrizheitia">
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1"></div>
                                <div className="w3-col l1 speaker-img-region">
                                    <img className="speaker-image berrizheitia-img" src={Berrizheitia}
                                         alt="berrizheitia"/>
                                </div>
                                <div className="w3-col l1"></div>
                                <div className="w3-col l1"></div>
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Professor and Chair of Landscape Architecture,
                                            Harvard
                                            Graduate School of Design</p>
                                        <p>
                                            Anita Berrizbeitia is a landscape architect specializing in theory and
                                            criticism
                                            of nineteenth and twentieth-century public landscapes in the US and Europe,
                                            with
                                            particular interests in material culture, design expression, and the
                                            productive
                                            functions and roles of landscape in processes of urbanization. Berrizbeitia
                                            is
                                            editor of several publications, including: <i>Urban Landscape—Critical
                                            Concepts
                                            in Built Environment Series and Michael Van Valkenburgh Associates:
                                            Reconstructing Urban Landscapes.</i> She is an award-winning author of books
                                            and
                                            essays, including: <i>Roberto Burle Marx in Caracas: Parque del Este,
                                            1956–1961;
                                            Inside/Outside: Between Architecture and Landscape; Studies in the History
                                            of
                                            Gardens & Designed Landscapes: An International Quarterly; Center for
                                            Advanced
                                            Studies in the Visual Arts; Cultural History of Gardens—The Modern Period;
                                            Daniel Urban Kiley: The Early Gardens; Recovering Landscape; Roberto Burle
                                            Marx:
                                            ...
                                            serves on the editorial boards of JoLA, of the South American Project, and
                                            has
                                            served on major competition juries in the United States and in Chile,
                                            Ecuador,
                        ...
                        <div className="individual-speaker name-column vanboxel">
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-name-col">
                                    <div className="sp-name">
                                        <h3 className="speakerName"><a name="vanBoxelKoreman">Elma van Boxel and
                                            Krisitan
                                            Koreman</a></h3>
                                    </div>
                                </div>
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Founding Directors, ZUS [Zones Urbaines
                                            Sensibles]</p>
                                        <p>
                                            ...
                                            research in the fields of architecture, urban development, and landscape
                                            design.
                                            Founded in 2001, the company consists of a 28-strong international and
                                            multidisciplinary team, based in Rotterdam. ZUS works with a belief that
                                            every
                                            place has the potential to become unique and thrilling. A spatial
                                            intervention
                                            should therefore always be inspired by the specific qualities of the
                                            situation
                                            and driven by an optimistic attitude. With design for urban districts,
                                            parks,
                                            public spaces, buildings and installations ZUS contributes to a collective
                                            and
                                            sustainable future. Architecture has become marginalized in the last two
                                            decades
                                            by responding mainly to the demands of the market. ZUS reclaims the public
                                            role
                                            of the architect by making social challenges explicit by means of
                                            unsolicited
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Founding Partner and CEO, James Corner Field
                                            Operations </p>
                                        <p>
                                            James Corner is the Founding Partner and CEO of James Corner Field
                                            Operations.
                                            James has devoted the past 30 years to advancing the field of landscape
                                            architecture and urbanism, through his leadership on high-visibility,
                                            complex
                                            urban projects at Field Operations, as well as through teaching, public
                                            speaking
                                            and writing. James’ work has been recognized with the National Design Award;
                                            the
                                            American Academy of Arts and Letters Award in Architecture; the AA&D Black
                                            Pencil Award; and the Chrysler Design Award. His work has been published
                                            broadly
                                            and exhibited at the New York Museum of Modern Art; the Cooper-Hewitt Design
                                            Museum; the National Building Museum; the Royal Academy of Art in London;
                                            and
                                            the Venice Biennale. His books include <i>The High Line; The Landscape
                                            Imagination; and Taking Measures Across the American Landscape.</i> James is
                                            an
                                            emeritus Professor of Landscape Architecture and Urbanism at the University
                                            of
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            architects. He studied architecture in Geneva, Zurich and London (AAGS).
                                            Georges
                                            has taught at University of Geneva School of Architecture, the Berlage
                                            Institute, visiting professor at Harvard GSD, University of Virginia School
                                            of
                                            Architecture, Berkeley University, Rapperswill School of Landscape
                                            Architecture,
                                            and lectured extensively in Europe, USA, Israel, China and South America.
                                            Among
                                            his realizations are Park in Lancy, Swiss Path, Bijlmer memorial in
                                            Amsterdam,
                                            Parc de la Cour du Maroc in Paris. He is presently working on the River Aire
                                            restoration project in Geneva, on Lyon Confluence riversides, the Ostende
                                            Green
                        ...
                        <div className="individual-speaker name-column garland">
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-name-col">
                                    <div className="sp-name">
                                        <h3 className="speakerName"><a name="garland"><a name="gm">James A. Garland,
                                            AIA, NCARB President</a></a></h3>
                                    </div>
                                </div>
                                <div className="w3-col l1"></div>
                                <div className="w3-col l1"></div>
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            James Garland founded Fluidity Design Consultants in 2002 after twenty years
                                            of
                                            practice in water design, architecture and urbanism. Jim began working in
                                            water
                                            at Wet Design as a consultant in 1986 while maintaining a private practice,
                                            then
                                            switching to full time in 1994 to ultimately become Wet’s Director of
                                            Design.
                                            Jim’s major projects included: Canal City Hakata (Fukuoka, Japan), Al
                                            Faisaliah
                                            (Riyadh, Saudi Arabia), Lisbon Expo ‘98 (Lisbon, Portugal) Millenium Park
                                            (Singapore), the Rose Garden Arena (Portland, Oregon), the Burj Al Arab
                                            (Dubai,
                                            UAE) and Water Tower Place (Chicago, USA). During this period, Jim also
                                            designed
                                            water features in Kuala Lumpur, Chicago, Singapore, Beijing, Shanghai,
                                            Seoul,
                                            Berlin, Miami Beach and Houston. Jim Garland holds a Masters degree in
                                            Architecture from UCLA, with a focus in architectural design and urban
                                            design.
                                            His undergraduate degree, also in architecture, was obtained from the
                                            University
                                            of Louisiana. Jim interned at Urban Innovations Group under Charles W.
                                            Moore,
                                            FAIA, an internationally celebrated architect who was known, among many
                                            things,
                        ...
                        <div className="individual-speaker name-column geuze">
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-name-col">
                                    <div className="sp-name">
                                        <h3 className="speakerName"><a name="geuze">Adriaan Geuze, Prof., Ir., RLA,
                                            OALA</a>
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            planning and design of the built environment. Adriaan, together with his
                                            office,
                                            has brought West 8 to the frontline of international urban design and
                                            landscape
                                            architecture for nearly 30 years now. As a key player in the field of
                                            landscape
                                            urbanism, nurturing landscape design's role as a powerful force in shaping
                                            our
                                            world sustainably and with sensitivity, he approaches landscape with a
                                            combination of natural inclination and urban know-how: a technique of
                                            relating
                                            contemporary culture, urban identity, architecture, public space and
                                            engineering
                                            within one design while always taking the context into account.
                                            Internationally
                                            respected as a professor in Architecture and Urban Design, Adriaan
                                            frequently
                        ...
                        <div className="individual-speaker name-column girot">
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Head of the Institute of Landscape Architecture,
                                            Dean
                                        ...
                                        <p>
                                            ...
                                            research interests span new topological methods in landscape design,
                                            landscape
                                            perception and analysis through new media, and contemporary theory and
                                            history
                                            of landscape architecture. At the ETH he co-founded the Landscape
                                            Visualising
                                            and Modelling Laboratory (LVML) with Professor Adrienne Gret-Regamey in
                                            2010.
                                            His professional practice focuses on large-scale landscape
                                            projects, using advanced 3D GIS techniques that contribute to the design of
                                            more
                                            sustainable landscape environments such as the Alptransit Deposit in
                                            Sigirino
                                            and the Third Rhône River Correction in the Canton of Valais. He directed an
                                            advanced design research project on the Ciliwung River in Jakarta for the
                                            ETH
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            University in St. Louis, taught at Harvard University, and practiced at
                                            Peter
                                            Walker and Partners. She has lectured and written on landscape modernism.
                                            She is
                                            the author of the books <i>The Modernist Garden in France, Garrett Eckbo:
                                            Modern
                                            ...
                                            several symposia on historical and contemporary topics. She continues to
                                            engage
                                            in research and design practice and recently completed the Novartis Square
                                            in
                                            Basel, Switzerland.
                                        </p>
                                    </div>
                        ...
                        <div className="individual-speaker name-column jones">
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Senior Principal, Hargreaves Associates and
                                            Hargreaves
                                            Jones</p>
                                        <p>
                                            Mary Margaret Jones is Senior Principal and President of Hargreaves
                                            Associates
                                            ...
                                            international awards and is the recipient of the 2016 Cooper Hewitt
                                            Smithsonian
                                            ...
                                            Crissy Field in San Francisco's Presidio; now a national park. Ms. Jones is
                                            the
                                            Prince Charitable Trust Fellow in Landscape Architecture of the American
                                            Academy
                                            ...
                                            Fellow of the American Society of Landscape Architects; Sr. Fellow of the
                                            Design
                                            Futures Council; past member of the National Advisory Council for the
                                            Mayors’
                                            ...
                                            Administration; and Fellow of the Urban Design Forum, New York, New York.
                                            She is
                                            currently leading the firm’s work on the 70-acre park that will link
                                            downtown to
                                            the river in Oklahoma City, a new open space for MIT that will be the
                                            centerpiece of 1 million sq. ft.<sup>2</sup> of new development, and the
                                            recently completed 35-acre
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            Tilman Latz has over 20 years of professional experience in a wide variety
                                            of
                                            projects. Deeply committed to ecological urban renewal, he is also
                                            interested in
                                            the socio-political potential of combined planning strategies, the interface
                                            of
                                            ...
                                            harbours in Bremerhaven into a new neighbourhood centre and the
                                            transformation
                                            of Turin’s largest urban industrial wasteland into Parco Dora, the
                                            conversion of
                                            the former port Rambaud in Lyon, the redevelopment of Place Flagey in
                                            Brussels,
                                            St Peter’s Square in Manchester, the Kleiner Tiergarten Park in Berlin. When
                                            Tilman was appointed to lead an interdisciplinary team to design the master
                                            plan
                                            for Crystal Palace Park in 2006, he established a branch office in London,
                                            which
                                            also completed a number of projects in the United Kingdom. He and his team
                                            are
                                            currently working in Israel, Russia and China alongside projects in the
                                            European
                                            Union. Beyond that Tilman is actively engaged in the Bavarian board of the
                                            BDLA
                                            (Federation of German Landscape Architects) and in the German Werkbund
                                            Bavaria.
                                            Tilman Latz graduated in landscape architecture from the University of
                                            Kassel in
                        ...
                        <div className="individual-speaker name-column lee">
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Reuben M. Rainey Professor in the History of
                                            Landscape
                                            Architecture <br/>Associate Professor of Landscape
                                            Architecture<br/> University
                                            of Virginia School of Architecture</p>
                                        <p>
                                            Michael Lee’s research explores the intersection of philosophy, technology,
                                            and
                                            landscape design, with a particular focus on 18th- to 20th-century Germany.
                                            His
                                            ...
                                            gender in Weimar Germany. Lee is the author of <i>The German “Mittelweg”:
                                            Garden
                                            Theory</i> and <i>Philosophy in the Time of Kant</i>, co-editor with Mirka
                                            Beneš
                                            of <i>Clio in
                                            ...
                                            and the Garden.</i> From 2009 to 2012 Lee was a postdoctoral associate in
                                            Garden
                                            and
                                            Landscape Studies at Dumbarton Oaks in Washington, D.C. He has previously
                                            taught
                                            at the Harvard Graduate School of Design, the Rhode Island School of Design,
                                            and
                                            Connecticut College. Trained as a landscape architect and historian, Lee
                                            received an MLA and a Ph.D. from Harvard University and a BSLA from Texas
                                            A&M
                                            University.
                                        </p>
                                    </div>
                        ...
                        <div className="individual-speaker name-column lister">
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-name-col">
                                    <div className="sp-name">
                                        <h3 className="speakerName"><a name="lister">Nina-Marie E. Lister, MCIP, RPP,
                                            Honorary
                                            ASLA</a>
                                        </h3>
                                    </div>
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            Nina-Marie Lister is Graduate Program Director and Associate Professor in
                                            the
                                            ...
                                            Urban Planning at Harvard University, Graduate School of Design. A
                                            Registered
                                            Professional Planner (MCIP, RPP) trained in ecology, environmental science
                                            and
                                            ...
                                            Professor
                                            Lister’s research, teaching and practice center on the confluence of
                                            landscape
                                            infrastructure and ecological processes within contemporary metropolitan
                                            regions, with a particular focus on resilience and adaptive systems design.
                                            At
                                            Ryerson University, Lister founded and directs the Ecological Design Lab, a
                                            collaborative innovation incubator for ecological design research and
                                            practice.
                                            She is a member of the Ryerson Urban Water Centre where she contributes work
                                            on
                                            flood-friendly design through green and blue infrastructure for resilience.
                                            She
                                            is co-editor of <i>Projective Ecologies and The Ecosystem Approach:
                                            Complexity,
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            environmental and social prerogatives. Orff was awarded the MacArthur
                                            Foundation
                                            ‘Genius’ Grant in 2017, the first given in the field of Landscape
                                            Architecture.
                                            She was named a 2012 United States Artist Fellow, an Elle Magazine “Planet
                                            Fixer,” and shared SCAPE’s design methodologies at the International
                                            TEDWomen
                                            ...
                                            Master in Landscape Architecture from the Graduate School of Design at
                                            Harvard
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            As the first P.S. du Pont Fellow, Colvin Randall has spoken all over the
                                            world
                                            about Longwood Gardens, its history, magnificent garden features, the
                                            evolution
                                            of its bucolic landscape, and the performing arts in the Gardens that take
                                            place
                                            throughout the year. He is also the author of three books on Longwood
                                            Gardens
                                            including the centennial publication, <i>Longwood Gardens: 100 Years of
                                            Garden
                                            Splendor</i>. Randall became interested in the history of Longwood Gardens
                                            in 1973
                                            as a Longwood Graduate Fellow researching the story of the garden’s
                                            fountains.
                                            Currently, Randall oversees Longwood’s fireworks displays, the world’s
                                            largest
                                            resident 10,010-pipe organ as well as the 62-bell carillon in the Chimes
                                            Tower.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            dedication to the beauty and sustainability of gardens, and to the training
                                            of
                                            future generations of horticulture professionals. A hallmark of Redman’s
                                            leadership is building a culture of planning to propel a shared vision
                                            forward.
                                            As the President and Chief Executive Officer of Longwood Gardens for the
                                            last 11
                                            ...
                                            Pierre S. du Pont. Most recently and notably, Paul led one of largest
                                            projects
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            Mark Robbins, an architect, artist, educator, and longtime advocate for art
                                            and design, is President of the American Academy in Rome -- the preeminent
                                            overseas center for independent study and advanced research in the arts and
                                            humanities. <br/> <br/>

                                            He was previously Executive Director of the International Center of
                                            Photography in New York, an institution dedicated to the presentation and
                                            interpretation of the reproduced image. From 2004 to 2012, as Dean and
                                            Professor at Syracuse University School of Architecture and University
                                            Senior Advisor on Architecture and Urban Initiatives, he had a
                                            transformative role on both the school and the city. While Director of
                                            Design at the National Endowment for the Arts, from 1999-2002, Mark led the
                                            development of an aggressive program to strengthen the presence of
                                            innovative design in the public realm. This included work with elected
                                            officials through the Mayors Institute on City Design and giving over 100
                                            public presentations that promoted design. From 1993 to 1999, he was Curator
                                            of Architecture at the Wexner Center for the Arts, where he created a
                                            laboratory for innovative work, and Associate Professor at the Knowlton
                                            School of Architecture at Ohio State University. He has been a visiting
                                            professor at the University of Virginia, Southern California Institute of
                                            Architecture (SCI-Arc), Georgia Institute of Technology and the Harvard
                        ...
                        <div className="individual-speaker name-column seavitt">
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-name-col">
                                    <div className="sp-name">
                                        <h3 className="speakerName"><a name="seavittnordenson">Catherine Seavitt
                                            Nordenson,
                                            ASLA,
                                            AIA, FAAR </a>
                                        </h3>
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Associate Professor of Landscape Architecture, The
                                            City
                                            College of New York <br/>Principal, Catherine Seavitt Studio</p>
                                        <p>
                                            Catherine Seavitt Nordenson is an associate professor of landscape
                                            architecture
                                            at The City College of New York and principal of Catherine Seavitt Studio,
                                            New
                                            York. A registered architect and landscape architect, she is a graduate of
                                            the
                                            Cooper Union and Princeton University, a fellow of the American Academy in
                                            Rome,
                                            and a recipient of a Fulbright Fellowship for research in Brazil. Her
                                            research
                                            includes design adaptation to climate change in urban environments, as well
                                            as
                                            the novel transformation of landscape restoration practices. She is also
                                            interested in the intersection of political power, environmental activism,
                                            and
                                            ...
                                            Roberto
                                            Burle Marx and Public Landscapes under Dictatorship; Corridor Workbook:
                                            Design
                                            Initiative for RPA’s Fourth Regional Plan; Waterproofing New
                                            York;</i> and <i>On the
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            contemporary urbanism. He coined the term ‘landscape urbanism’ to describe
                                            the
                                            emergent discourse and practices of landscape in relation to design culture
                                            and
                                            ...
                                            Reader.</i> Waldheim
                                            is the John E. Irving Professor at Harvard University’s Graduate School of
                                            Design
                                            where he directs the School’s Office for Urbanization. He is the recipient
                                            of the
                                            Rome Prize Fellowship from the American Academy in Rome; the Visiting
                                            Scholar
                                            Research Fellowship at the Study Centre of the Canadian Centre for
                                            Architecture;
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        ...
                                        <p>
                                            ...
                                            partner of the internationally recognized design practice Lateral Office.
                                            His
                                            design work and research considers architecture in relationship to
                                            environment
                                            and infrastructure. He is the recipient of the 2012-13 Howard Friedman
                                            Visiting
                                            Professorship in the Practice of Architecture at UC Berkeley College of
                                            Environmental Design and the 2008-09 Arthur Wheelwright Fellowship from
                                            Harvard
                                            Graduate School of Design. White is author of <i>Many Norths: Spatial
                                            Practice
                                            in a
                        ...
                        <div className="individual-speaker name-column yu">
                            ...
                            <div className="w3-row">
                                ...
                                <div className="w3-col l1 speaker-desc-col">
                                    <div className="speaker-desc">
                                        <p className="speakerTitle">Changjiang Chair Professor of Design, Peking
                                            University
                                        ...
                                        <p>
                                            ...
                                            Design, Kongjian Yu is founder of the College of Architecture and Landscape
                                            at
                                            Peking University. In addition, he is the founder and president of
                                            Turenscape,
                                            one of the first and largest private urbanism and landscape architecture
                                            firms
                                            ...
                                            theory for national land use planning, eco-city campaign, and urban
                                            ecological
                                            restoration. His practice includes landscape and urbanism in major cities
                                            around
                                            the world. His guiding design principles are the appreciation of the
                                            ordinary
                                            and a deep embracing of nature, even in its potentially destructive aspects,
                                            such as urban flooding. His numerous awards include 13 ASLA Excellence and
                                            Honor Awards and a 2009 Urban Land Institude Global Award, and 5 World's
                                            Best Landscape of the Year Awards
