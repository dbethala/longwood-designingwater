            ...
            <div className="schedulePageWrapper">
                ...
                <div className="w3-row">
                    ...
                    <div className="schedule-body" id="scheduleBody">
                        ...
                        <Event timestamp="3:30-3:45 pm" eventHeading="Symposium Organization & Conceptual Framework" eventDesc="Julia Czerniak, Associate Dean and Professor, Syracuse Architecture" />
                        <Event timestamp="3:45-4:45 pm" eventHeading="Keynote Designing WATER: from Delphi to Disney" eventDesc="Christophe Girot, Professor and Chair of Landscape Architecture at the Architecture Department of the ETH, Zurich" />
