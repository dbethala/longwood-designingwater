            ...
            <div className="schedulePageWrapper" style={{maxWidth: '1280px', margin: '0 auto'}}>
                ...
                <div className="schedule-body" id="scheduleBody">
                    ...
                    <Event day="Thursday" timestamp="9:00-9:15 am" eventHeading="Welcome"
                           eventDesc="Paul B. Redman, President and CEO of Longwood Gardens, and Mark Robbins, President and CEO of the American Academy in Rome"/>
                    <Event day="Thursday" timestamp="9:15-11:15 am" eventHeading="Pleasure, People & Other Populations"
                           eventDesc=
                               {
                                   [<i>Pleasure, People & Other
                                       ...
                                       <li className="case-studies-list-item"
                                           style={{display: "list-item", listStyleType: "disc"}}>Kate Orff, founder and
                                           design director of SCAPE Landscape Architects, Associate Professor and
                                           Director, Urban Design Program, at Columbia GSAPP</li>,
                                       <li className="case-studies-list-item"
                                           style={{display: "list-item", listStyleType: "disc"}}>Mary Margaret Jones,
                                           President and Sr. Principal, Hargreaves Associates</li>,
                                       <li className="case-studies-list-item"
                                           style={{display: "list-item", listStyleType: "disc"}}>Georges Descombes,
                                           Professor of Architecture, University of Geneva; practicing architect,
                                           Geneva</li>,
                                       <br/>,
                                       <br/>,
                    ...
                    <Event day="Thursday" timestamp="1:15– 3:15 pm"
                        ...
                        <br/>,
                        <li className="case-studies-list-item"
                            style={{display: "list-item", listStyleType: "disc"}}>Kongjian Yu, Dean of the School of
                            Landscape Architecture at PKU, founding partner, Turenscape </li>,
                        <li className="case-studies-list-item"
                            style={{display: "list-item", listStyleType: "disc"}}>Kristian Koreman and Elma van Boxel,
                    ...
                    <Event day="Thursday" timestamp="3:30–5:30 pm" eventHeading="Technology, Innovation, and the Future"
                           eventDesc={[
                               ...
                               <br/>,
                               <li className="case-studies-list-item"
                                   style={{display: "list-item", listStyleType: "disc"}}>James Corner, Principal, James
                                   Corner Field Operations</li>,
                               <li className="case-studies-list-item"
                                   style={{display: "list-item", listStyleType: "disc"}}>Catherine Seavitt Nordenson,
                                   Associate Professor, Landscape Architecture Program, City College of NY</li>,
                               <li className="case-studies-list-item"
                                   style={{display: "list-item", listStyleType: "disc"}}>James A Garland, AIA, NCARB,
